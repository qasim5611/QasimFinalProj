...
import {sendToActionFORConfirmTeacher1} from './../Redux/Action/action';
import {sendToActionFORConfirmTeacher2} from './../Redux/Action/action';
import {connect} from 'react-redux'; 

import {sendToActionFORRetriveTeacher} from './../Redux/Action/action';
...
export class TeacherSignIn extends Component {
  ...
  componentWillMount() {
    ...
    this.props.sendToActionFORRetriveTeacher();
  ...
  sendToActionFORConfirmTeacher1 = () =>{
...
// alert('your credentials are' + obj.email + ' ' + obj.password);
    this.props.sendToActionFORConfirmTeacher1(obj);
   ...
   console.log('checked',this.props.data);
       ...
       sendToActionFORConfirmTeacher2 = () =>{
    ...
    this.props.sendToActionFORConfirmTeacher2(obj);
      ...
      <Paper >
        ...
        <form >
         ...
         <Button
          ...
          onClick={this.sendToActionFORConfirmTeacher1}
        ...
        >
         ...
         <Button
          ...
          style={{backgroundColor:'#607d8b', color:'white', width:'230px'}}
          // onClick={this.CallFuncTwice}
          onClick={this.sendToActionFORConfirmTeacher2}
...
const mapStateToProps = (store) => {
  console.log('+++++++++++state++++++++++++++++',  store.ReducerForDBdata.LoginSF);

  return {
    // rtitle : store.title,
    // rDiscription:  store.descp,
    data: store.ReducerForDBdata.LoginSF
  //data: store.ReducerForDBdata.StateForFirebase   For Firbase DB case

  }
}
export default connect(mapStateToProps, {sendToActionFORConfirmTeacher1,sendToActionFORConfirmTeacher2, sendToActionFORRetriveTeacher }) (TeacherSignIn)
