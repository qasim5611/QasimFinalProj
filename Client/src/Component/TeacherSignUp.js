...
import {sendToActionFORSAVETeacher} from './../Redux/Action/action';
...
export class StudentSignUp extends Component {
  ...
  sendToActionFORSAVETeacher = () =>{
    ...
    this.props.sendToActionFORSAVETeacher(obj);   //action waly AddRecordToStore function ko call kia,
   // this.props.AddToFirebase(obj); if we want to store data on firebase regardless od node js/MongoDb
  this.props.history.push('/TeacherForm');
      }
       else{
         alert('Sorry');
       }
      ...
      <Paper >
        ...
        <FormControl margin="normal" required="required" fullWidth>
          ...
          <Button
            ...
            onClick={this.sendToActionFORSAVETeacher}
...
export default connect(mapStateToProps, {sendToActionFORSAVETeacher }) (StudentSignUp)
